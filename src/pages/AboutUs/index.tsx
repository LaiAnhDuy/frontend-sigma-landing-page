    ...
    return (
        <div className="container m-auto">
            <div className="">
                ...
                <p className="text-main text-[21px] font-medium -mt-5">We are proud of over 10 years of experience in developing technology solutions for content providers and telecom businesses in Vietnam and international market. Our goal is to provide best-in-class solutions with the highest quality services for customers</p>
                ...
                <div>
                    ...
                    <hr className="color-hr w-[300px] h-[17px] rounded-[20px] -mt-12"></hr>
                    <p className="color-p text-lg font-medium">Our total Sigma Solution suite includes:</p>
                </div>
