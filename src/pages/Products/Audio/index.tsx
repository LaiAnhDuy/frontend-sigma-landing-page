...
const Audio = () => {
  return (
    <div className="m-auto">
      <div className="container grid grid-cols-2 justify-between h-auto">
        <div>
          ...
          <button className="bg-orange-400 text-white rounded border-none w-32 h-10 text-2xl">
            Free trial
          </button>
        </div>
      ...
      <div className="container bg-orange-400 rounded-2xl text-white">
      ...
      <div className="container text-center mt-20 border-dashed border">
        <h1 className="mt-10">
      ...
      <div className="container bg-slate-50 pt-6 mt-24">
        ...
        <div className='pb-10'>
          <div className="grid grid-cols-2 m-16 mx-48 bg-white">
            ...
            <div className="ml-5 mr-32">
              <h1 className="mt-16 text-2xl">Client-Side Audio Watermarking</h1>
              <p>
          ...
          <div className="grid grid-cols-2 m-16 mx-48 bg-white">
            <div className="mr-5 ml-24">
              ...
              <p>
                ...
                source and target of distribution, ensuring traceability of any
                content leak independent of device type.
              </p>
            </div>
          ...
          <div className="grid grid-cols-2 m-16 mx-48 bg-white">
            ...
            <div className="ml-5 mr-32">
              ...
              <p>
                ...
                during content delivery with easy CDN integration. Imperceptible
                and robust, session-based watermarking protects against a wide
                range of attacks, including collusion and playlist shuffling.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="container text-center m-16">
        ...
        <button className="bg-orange-400 text-white text-xl border-none rounded-2xl w-52 h-10">
          Contact Us
        </button>
      </div>
    </div>
